...
export class CommandCenter {
	...
	async openResource(resource: Resource, preserveFocus: boolean): Promise<void> {
		...
		const config = workspace.getConfiguration('vsr', Uri.file(repository.root));
			...
			return result.catch(async err => {
				...
				switch (err.gitErrorCode) {
					...
					case VsrErrorCodes.AuthenticationFailed:
						...
						break;
					case VsrErrorCodes.NoUserNameConfigured:
					case VsrErrorCodes.NoUserEmailConfigured:
